...
const geojsonIsFeatureCollection = (filePath) => {
  return new Promise((resolve, reject) => {
    ...
    reader.pipe(split())
      .on('data', (line) => {
        // TODO: This isn't really adequate, e.g. an "id" property on a
        // feature could have the value "features". Also, the file could be
        // one gigantic line, so is splitting by line a bad idea?
        // How can we effectively fine `"features"\s*:`
